...
using Atividade.Models.Context;
...
namespace Atividade.Controllers
{
    public class Modelos3DController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Modelo3DID,Nome,Historia,Altura,Peso,NumeroDePoligonos,TipoModelo3DID")] Modelo3D modelo3D)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Modelo3DID,Nome,Historia,Altura,Peso,NumeroDePoligonos,TipoModelo3DID")] Modelo3D modelo3D)
        {
            if (ModelState.IsValid)
            {
